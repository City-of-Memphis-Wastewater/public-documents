...
The report identifies various specialized machinery used in wastewater processing and facility maintenance:

* **Pumps:** Raw sewage pumps (RSP #1–4), primary sludge pumps, Borger grease pumps, screw pumps (#3, #7), return sludge pumps, and WEMCO pump motors.
* **Treatment Systems:** Coarse bar screens (CBS), fine bubble diffusers (FBD), primary clarifiers, trickling filters (TF1–6), and secondary clarifiers.
* **Dewatering \& Sludge:** Belt filter presses (BFP), new Ashbrook presses, and a neat polymer system.
* **Infrastructure/Other:** Main aeration blowers, grit cranes, mag meters, and a 15-ton Trane HVAC unit.

### Contractors Mentioned

Several private entities were involved in repairs, engineering, and new construction:

* **Chris Hill Construction:** Handled the primary sludge pumping upgrade, pump station upgrades, and secondary dewatering projects.
* **CDM Smith:** Engaged for design work on the solar farm, grey water facility, and evaluating tertiary treatment options.
* **Xylem:** Managed bypass pumping and provided valve management plans.
* **USP Technologies (US Peroxide):** Conducted hydrogen sulfide surveys and managed odor control systems.
* **Gresham Smith:** Chosen by xAI as their design engineer for the MBR (Membrane Bioreactor) facility.
* **Other notable mentions:** Kiewit Construction (flare installation), BioWizard (EBS report review), and Trinova (meter calibration).



### Interesting Vocabulary

* **Grey Water:** Treated wastewater intended for reuse in cooling or industrial processes rather than being discharged.
* **Mixed-Liquor Suspended Solids (MLSS):** The concentration of suspended solids in an aeration tank during the activated sludge process.
* **FOG:** Fats, Oils, and Grease, which caused significant blockages in 2024.
* **Struvite:** A phosphate mineral that can form in wastewater equipment, often favoring areas of high turbulence.
* **QAC (Quaternary Ammonium Salt):** A cationic surfactant identified in grease samples, typically found in skincare products.



### Failure Modes Indicated

The facilities experienced multiple mechanical and operational failures:

* **Grease Blockage:** 12–18 inches of heavy grease prevented the restart of bypass systems and caused primary clarifier overflows.
* **Excessive Vibration:** Recurrent in Raw Sewage Pump #1 and RAS blower motors, preventing stable service.
* **Over-Torquing:** Debris caused the south coarse bar screen rake to malfunction.
* **Flooding:** Tunnels flooded in December 2024, requiring the replacement of several motors.
* **Meter Inaccuracy:** Influent flow meters were suspected of over-reporting by up to 15 mgd following inverter installations.



### Key Performance Metrics

The plant tracks its efficiency through several standard wastewater indicators:

* **Removal Efficiency:** 82% removal for BOD and 80% for TSS.
* **Daily Flow:** Average daily flow was 76 mgd, a 10 mgd increase from 2023.
* **BOD/TSS Loading:** Influent BOD averaged 438,744 ppd (an 11% increase), and TSS averaged 389,204 ppd (a 15% increase).
* **Work Order Volume:** 6,039 total work orders completed in 2024 at the Maxson facility.



### Phenomena Tracked in Depth

* **Hydrogen Sulfide (H2S) Levels:** Extensive monitoring was conducted at the headworks and industrial discharge points (e.g., Solae) to manage odors and corrosion.
* **Foam Composition:** Scientists analyzed "thick, white greasy foam" to identify fatty acids like oleic and stearic acid to determine if their origin was petroleum or vegetable-based.
* **Rain-Induced Flow:** The facility tracks how many million gallons are added to the system per inch of rain (averaging 28 million gallons at Maxson).
* **Sludge Inventory:** Cumulative dry solids within lagoons are tracked, reaching over 766 million dry pounds.
